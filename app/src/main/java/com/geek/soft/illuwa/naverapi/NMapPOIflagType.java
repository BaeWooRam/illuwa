...
public class NMapPOIflagType {
	...
	public static final int CENTER = PIN + 1;

	public static final int CAFE_PIN = CENTER+1;
	public static final int ENT_PIN = CAFE_PIN+1;
	public static final int FOOD_PIN = ENT_PIN+1;
	public static final int PARKING_PIN = FOOD_PIN+1;
	public static final int SUBWAY_PIN = PARKING_PIN+1;
	public static final int BEER_PIN = SUBWAY_PIN+1;
